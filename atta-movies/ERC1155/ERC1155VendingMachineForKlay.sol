...
contract VendingMachineForKlay is Ownable {
    ...
    function _buyToken(address _buyer, uint256 _tokenId, uint256 _quantity) internal {
        ...
        (bool success, ) = treasury.call{value: _commodityPrices[_tokenId].mul(_quantity)}("");
        require(success, "Failed to send klay");
        emit Buy(_buyer, _tokenId, _quantity, _commodityPrices[_tokenId]);
    }
    
    function safeBuyToken(uint256 _tokenId, uint256 _quantity) public payable{
