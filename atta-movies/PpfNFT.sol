...
contract PfpNFT is ERC721Enumerable ,Ownable{
    ...
    function batchMintNFT(address[] calldata _to, string calldata _uri) external  {
    ...
    function safeMultipleBatchMint(address[] calldata _to, string[] calldata _uri) external {
