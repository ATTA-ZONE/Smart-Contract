...
import "../openzeppelin-contracts/contracts/token/ERC1155/../../utils/Address.sol";
import "../openzeppelin-contracts/contracts/token/ERC1155/../../utils/Context.sol";
import "../openzeppelin-contracts/contracts/token/ERC1155/../../utils/math/SafeMath.sol";
import "../openzeppelin-contracts/contracts/token/ERC1155/../../utils/introspection/ERC165.sol";
...
contract ERC1155Mintable is ERC1155 , Ownable{
    ...
    function safeBatchMint(address _to, uint256[] calldata _id, uint256[] calldata _quantities) external onlyMinter {
        _mintBatch(_to, _id, _quantities, '');
    }
    
    //mint tokens. Assign directly to _to[].
    function safeMint(address _to, uint256 _id, uint256 _quantities) external onlyMinter {
